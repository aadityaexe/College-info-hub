    ...
    <div className="flex flex-col min-h-screen overflow-hidden bg-background text-text-main transition-colors duration-500">
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Sarah J.', role: 'Software Engineer @ Google', quote: 'The mentorship I received here directly helped me crack my interviews. The alumni network is incredibly supportive!' },
              { name: 'Michael T.', role: 'Senior Product Manager', quote: 'I use this platform to recruit top talent from my alma mater. The quality of students here is unmatched.' },
              { name: 'Emily R.', role: 'Recent Graduate', quote: 'Found my dream internship through the exclusive job board. This community was my secret weapon in college.' }
            ].map((t, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} viewport={{ once: true }}
                ...
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center text-white font-bold">{t.name.charAt(0)}</div>
                  <div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-white font-serif font-bold text-lg">College Info <span className="text-amber-400">Hub</span></span>
              </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm">© {new Date().getFullYear()} College Info Hub. All rights reserved.</p>
